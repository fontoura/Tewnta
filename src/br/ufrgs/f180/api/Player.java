...
/**
 *   This is the main API provided to players to connect and communicate with the simulator. It's purpose is to provide
 *  the same sort of functionality a "vision" and a "motion" components would do in a real robotic soccer game.
 *   The APIs are published as a web-service and are available as soon as the system starts up.
 *   
 *   A regular game flow requires:
 *   1- Login your team using the login API
 *   2- Add up to 5 players using the setPlayer API
 *   3- Provide motion to your players thru the player APIs
 *   4- Read the players position and information thru the player APIs 
 *   5- Disconnect the team thru the logout API
 *   
...
public interface Player {
	...
	/**
	 *   Logs in a team.
	 *   Notice the team is identified by its name, thus no duplicate names are allowed.
	 *   This API will define the team name in the simulator window as well as provide a logical view of the team. 
	 * @param teamName is the team name to be displayed.
	 * @return the unique team identifier that will be necessary in the subsequent API calls.
	 * @throws Exception
	 */
	...
	/**
	 *   Configures a robot. If a robot with the given ID is not present, it will be created.
	 * @param teamId the unique identifier for the team, result of a login API invocation.
	 * @param id the identifier of the robot that shall be configured.
	 * @param x the initial horizontal position of the robot in the field. 0 being the left.
	 * @param y the initial vertical position of the robot in the field. 0 being the bottom.
	 * @throws Exception
	 */
	void setPlayer(String teamId, String id, Double x, Double y) throws Exception;
	
	/**
	 *   Sets a force vector that will be used for robot motion. Considering the robots are omnidirectional it is 
	 ...
	 * @param x horizontal component of the force vector
	 * @param y vertical component of the force vector
	 * @throws Exception
	 */
	 ...
	 *   Can be used to get the information of all robots with a single API invocation.
	 * @param teamId the team that shall return the info.
	 * @return
	 */
	 ...
	 * @param playerId the robot that shall return the info.
	 * @return
	 */
